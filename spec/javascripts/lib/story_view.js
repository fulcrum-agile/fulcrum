var StoryView = FormView.extend({
  ...
  render: function() {
    if(this.model.get('editing') === true) {
      ...
      if (!this.model.isNew()) {
        $(div).append(
<<<<<<< HEAD:public/javascripts/views/story_view.js
          this.make("a", {'class': "collapse icon icons-collapse"})
=======
          this.make("img", {'class': "collapse", 'src': "/assets/collapse.png"})
>>>>>>> Move to Rails 3.1 Asset Pipeline. Had to duplicate story_view.js to get Jasmine tests passing. Need to work out how to integrate Jasmine with the asset pipeline:spec/javascripts/lib/story_view.js
        );
      }
