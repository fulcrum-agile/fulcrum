...
Devise.setup do |config|
  ...
  config.authentication_keys = [ :email, :team_slug ]
  ...
  config.strip_whitespace_keys = [ :email, :team_slug ]
  ...
  config.confirmation_keys = [ :email, :team_slug ]
  ...
  config.unlock_keys = [ :email, :team_slug ]
  ...
  config.reset_password_keys = [ :email, :team_slug ]
